...
class Child(Person):
    ...
    address_registered = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="address_registered",
    )
    ...
    mother = models.ForeignKey(
        Parent, on_delete=models.CASCADE, null=True, blank=True, related_name="mother"
    )
    father = models.ForeignKey(
        Parent, on_delete=models.CASCADE, null=True, blank=True, related_name="father"
    )
    foster_carer = models.ForeignKey(
        FosterCarer, on_delete=models.CASCADE, null=True, blank=True
    )
...
class Siblings(models.Model):
    ...
    child_sibling = models.ForeignKey(
        Child, related_name="child_sibling", on_delete=models.CASCADE
    )
