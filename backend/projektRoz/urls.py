...
from projektRoz.apiViews import (AddressApiView, ChildrenApiView,
                                 DocumentsApiView, FileApiView,
                                 FosterCarerApiView, NotesApiView,
                                 ParentApiView, SiblingsApiView)
...
urlpatterns = [
    ...
    path(
        "api/parent/<str:role>/<int:parent_id>", ParentApiView.as_view(), name="parent"
    ),
    ...
    path(
        "api/address/<str:type>/<int:address_id>",
        AddressApiView.as_view(),
        name="address",
    ),
    path("api/foster_carer/", FosterCarerApiView.as_view(), name="foster_carer"),
    path(
        "api/foster_carer/<int:foster_carer_id>",
        FosterCarerApiView.as_view(),
        name="foster_carer",
    ),
    ...
    path(
        "api/documents/<int:document_id>", DocumentsApiView.as_view(), name="documents"
    ),
